    ...
    return (
        <div>
            <NavBarTemplate>
                ...
                <Text>
                    There is decision-making, and then there is informed decision-making. Informed decision-making involves careful analysis. Anyone can make a knee-jerk decision—impulsively buying a used car, angrily quitting a job after a difficult shift, or carelessly chasing a ball into the street. If the outcome of such a decision is good, it&rsquo;s only because the person got lucky.
                </Text>
                <Text>
                ...
                <Text>
                    The PACED model is a structured approach to decision-making that helps you make informed and rational choices. Here&rsquo;s how it works:
                </Text>
                <List>
                    <ListItem>
