import { Card, Text, SimpleGrid, UnstyledButton, Title, Center, Image, AspectRatio, Group, useMantineTheme, Container, Grid, Stack, px, Skeleton, Overlay, Button } from "@mantine/core";
  ...
  const cards = mockdata.map((article) => (
    <Card key={article.title} p="md" radius="md" component="a" href="#" className={classes.card}>
      <AspectRatio ratio={1920 / 1080}>
        <Image src={article.image} className={classes.cardImg} />
      </AspectRatio>
      <Text className={classes.title}  mt="sm">
        {article.title}
      </Text>
      <Text c="dimmed" size="xs" fw={500} mt={1} >
        Course: <Text component="span" fw={650} style={{ color: '#A9A9A9' }}>{article.course}</Text>
      </Text>
...
<Container fluid style={{ marginTop: '3rem', marginLeft: '3rem' }}>
      <Grid gutter="xl">
        <Grid.Col span={{ base: 12, xs: 8 }} className={classes.containerBg} style={{ marginRight: '4.5rem' }}>
        ...
        <Grid.Col span={{ base: 12, xs: 3 }}>
          <Stack spacing="lg"> {/* Stack the grids vertically */}
            
            <SimpleGrid
              cols={{ base: 1, sm: 1 }}

              spacing="lg"
              style={{ backgroundColor: 'rgb(26, 25, 25)', marginTop: "-1rem", marginRight: "-1rem", marginLeft: "-1rem", paddingBottom: "3rem", borderRadius: "20px"}} // Distinct background color
            >
              <Title size="22px" my="xl" mx="xl">
              Additional Info
            </Title>
              <Stack spacing="xl">
                <Card radius="md" className={classes.card1} style={{marginLeft: "1.5rem", marginRight: "1.5rem", marginBottom: "1rem", marginTop: "-1.5rem"}}>
                  <Overlay className={classes.overlay1} opacity={0.55} zIndex={0} />
                ...
                <Card radius="md" className={classes.card1} style={{marginLeft: "1.5rem", marginRight: "1.5rem"}}>
                  <Overlay className={classes.overlay1} opacity={0.55} zIndex={0} />
                  <div className={classes.content}>
                    <Text size="lg" fw={700} className={classes.title1}>
                      Plan & save
            ...
            <SimpleGrid
              ...
              spacing="lg"
              style={{ backgroundColor: 'rgb(26, 25, 25)', marginTop: "1rem", marginRight: "-1rem", marginLeft: "-1rem", paddingBottom: "3rem", borderRadius: "20px"}}>
                 <Title size="22px" my="xl" mx="xl">
              External Links
            </Title>

                <Card radius="md" className={classes.card1} style={{marginLeft: "1rem", marginRight: "1rem", marginTop: "-1.5rem"}}>
                  <Overlay className={classes.overlay1} opacity={0.55} zIndex={0} />
                  <div className={classes.content}>
                    <Text size="lg" fw={700} className={classes.title1}>
                      Plan & save
