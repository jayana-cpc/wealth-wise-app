  ...
  return (
    <Container>
      <Paper shadow="sm" p="md">
        <Space h="lg" />
        <Title order={1} c="white" id="stock-selection">
          Stock Selection
        </Title>
        <Space h="md" />
        <Text>
          Lets begin the stock valuation journey with selecting the company we
          want to value!{" "}
        </Text>
        <Space h="md" />
        <Space h="md" />
        <Title order={2} c="white" id="11-gics-sectors">
          The 11 GICS Sectors
        </Title>
        <Space h="md" />
        <Text c="white">
          Understanding the 11 GICS sectors is essential for choosing which
        ...
        <Space h="xl" />
        <Title order={2} c="white" id="personalization-survey">
          Personalization Survey
        </Title>
        <Space h="md" />
        <Text c="white">
          Take a short 10 question survey to get some stock recommendations!{" "}
        </Text>
        <Space h="md" />
        <StockSurveyCard />
        <Space h="xl" />
        <Title order={2} c="white" id="select-company">
          Select a Company to Analyze
        </Title>
        <Space h="md" />
        <Text c="white">
          After doing a bit of research, search up the company you want to
          analyze!{" "}
        </Text>
        <Space h="md" />
        <Center>
