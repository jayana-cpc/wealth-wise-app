      ...
      messages: [
        {
          role: "system",
          content:
            "Given a company, write a concise 3 sentence analysis on competitive rivalry among existing competitors in the company's industry.",
        },
        {
          role: "user",
          content: stockSymbol,
