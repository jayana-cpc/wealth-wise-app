      ...
      messages: [
        {
          role: "system",
          content:
            "Given a company, write a concise 3 sentence analysis on the threat of substitute products or services in the company's industry.",
        },
        {
          role: "user",
          content: stockSymbol,
