  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        Price over Free Cashflow Relative Analysis
      </div>
      <div className={styles.content}>
        <div className={styles.row}>
          ...
          />
          <span>
            {data.stockSymbol} Price/Cashflow:{" "}
            {parseFloat(data.pricefcfratio3).toFixed(2)}
          </span>
        </div>
        <div className={styles.row}>
          <Image
          ...
          />
          <span>
            {data.stock1} Price/Cashflow:{" "}
            {parseFloat(data.pricefcfratio1).toFixed(2)}
          </span>
        </div>
        <div className={styles.row}>
          <Image
          ...
          />
          <span>
            {data.stock2} Price/Cashflow:{" "}
            {parseFloat(data.pricefcfratio2).toFixed(2)}
          </span>
        </div>
        <div>
          {loading ? (
