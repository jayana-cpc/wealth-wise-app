...
export function Section2Coverage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setAttempts(
        parseInt(localStorage.getItem("section2CoverageAttempts")) || 0,
      );
  ...
  return (
    <div>
      ...
      <Text>What does Section 2 mean?</Text>
      <Space h="sm" />
      ...
      {attempts >= 3 && (
        <>
          ...
          >
            <Text>
              Section 2 covers the length of the coverage period, when the
              coverage becomes effective, and when the coverage expires.
            </Text>
          </Modal>
