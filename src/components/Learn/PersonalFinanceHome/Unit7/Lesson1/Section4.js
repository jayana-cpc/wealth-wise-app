...
export function Section4Meaning() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setAttempts(
        parseInt(localStorage.getItem("section4MeaningAttempts")) || 0,
      );
  ...
  return (
    <div>
      ...
      <Text>What does Section 4 mean?</Text>
      <Space h="sm" />
      ...
      {attempts >= 3 && (
        <>
          ...
          >
            <Text>
              This section details the discounts of the insurance policy.
              Insurance discounts are reductions in premium costs offered by
              insurance companies to policyholders who meet certain criteria or
