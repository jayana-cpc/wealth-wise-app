...
export function CreditVsStoreCard() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setAttempts(
        parseInt(localStorage.getItem("creditVsStoreCardAttempts")) || 0,
      );
  ...
  return (
    <div>
      ...
      <Text>
        Explain the similarities and differences between credit cards and store
        cards.
      </Text>
      <Space h="sm" />
      ...
      {attempts >= 3 && (
        <>
          ...
          >
            <Text>
              Credit cards and store cards are both forms of credit that allow
              consumers to make purchases with borrowed money. However, they
              have distinct characteristics and considerations:
            </Text>
            <Text>
              <b>Similarities:</b>
            </Text>
            <List withPadding>
              <List.Item>
                Both credit cards and store cards allow users to defer payment
                for purchases, essentially taking out a short-term loan.
              </List.Item>
              <List.Item>
                They typically charge interest on outstanding balances that are
                not paid off by the due date.
              </List.Item>
              <List.Item>
                Both types of cards may offer rewards or incentives for usage,
            ...
            <List withPadding>
              <List.Item>
                <b>Interest Rates:</b> Store cards often have higher interest
                rates compared to regular credit cards. This makes them less
                favorable for carrying balances over time, as the cost of
                borrowing is higher.
              </List.Item>
              <List.Item>
                <b>Usage Limitations:</b> Store cards are typically limited to
                use at specific retailers or within a particular retail network,
                whereas credit cards are more widely accepted.
              </List.Item>
              <List.Item>
                <b>Terms and Conditions:</b> Credit card agreements tend to be
                more standardized and regulated, whereas store card terms can
                vary widely and may include specific store-related perks or
                restrictions.
              </List.Item>
            </List>
          </Modal>
