  ...
  return (
    <Container>
      <Text size="xl" weight={700}>
        Credit: Calculating the Cost
      </Text>
      <Text size="md" mt="sm">
        Investigate how the amount borrowed, interest rate, and monthly payments
        affect the repayment time and cost of using credit by entering amounts
        in the fields below.
      </Text>
      <Box mt="lg">
