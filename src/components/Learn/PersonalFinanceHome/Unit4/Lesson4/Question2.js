...
export function Problem2() {
  ...
  const [correctAnswer, setCorrectAnswer] = useState(
    "It will take approximately 8 years for Sarah&apos;s investment to double in value at an average annual return of 9%.",
  );
  ...
  return (
    <div>
      ...
      <Text>
        Sarah invests in a mutual fund that historically earns an average annual
        return of 9%. According to the Rule of 72, how long will it take for her
      ...
      {attempts >= 3 && (
        <>
          ...
          >
            <Text>
              According to the Rule of 72, it will take approximately 8 years
              for Sarah&apos;s investment to double in value at an average
              annual return of 9%.
            </Text>
          </Modal>
