...
export function Question3() {
  ...
  return (
    <div>
      ...
      <Text>
        A government imposes a new tax on the production of automobiles. How
        will this affect the supply of automobiles and the price of cars for
        consumers?
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          A new tax on the production of automobiles would likely decrease the
          supply of automobiles. The tax would increase production costs for car
          manufacturers, making it more expensive to produce each car. As a
          result, the supply curve for automobiles would shift to the left,
          leading to a higher equilibrium price for cars and a lower quantity of
