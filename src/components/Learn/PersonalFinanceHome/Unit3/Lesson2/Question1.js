...
export function Question1() {
  ...
  return (
    <div>
      ...
      <Text>
        Explain how a drought affecting corn crops would impact the supply of corn and the price of corn tortillas.
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          A drought affecting corn crops would likely decrease the supply of corn, as less corn would be produced. With a lower supply of corn, the price of corn would increase. This increase in the price of corn would also raise the cost of corn tortillas, as corn is the primary ingredient. Therefore, a drought would lead to higher prices for corn tortillas due to the decreased supply of corn.
        </Text>
      </Modal>
    </div>
  );
