...
export function Question2() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      setAttempts(parseInt(localStorage.getItem('question2Attempts')) || 0);
      setFeedback(localStorage.getItem('question2Feedback') || '');
    }
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    const APIBody = {
      ...
      messages: [
        {
          role: "system",
          content: `Evaluate the following answer for the question about the potential effects of a new, efficient method of producing solar panels on the supply of solar panels and the price of solar energy. If the answer is correct, respond with "Correct". If the answer is incorrect, respond with "Incorrect" and provide a helpful response but do not reveal answer.`
        },
        {
          role: "user",
          content: userInput,
  ...
  return (
    <div>
      ...
      <Text>
        Describe the potential effects of a new, efficient method of producing solar panels on the supply of solar panels and the price of solar energy.
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          A new, efficient method of producing solar panels would likely increase the supply of solar panels. This increased supply could lower the production costs of solar panels, making them more affordable. As a result, the price of solar energy might decrease, leading to greater adoption of solar energy solutions. The increased supply of solar panels would shift the supply curve to the right, leading to a lower equilibrium price for solar panels and solar energy.
        </Text>
      </Modal>
    </div>
  );
