...
const questions = [
  {
    ...
    options: [
      ...
      "Quantity supplied determines price.",
    ],
    correctAnswer: "As price increases, quantity supplied increases.",
    explanation:
      "The law of supply states that as the price of a good or service increases, the quantity supplied will also increase, assuming all other factors remain constant.",
  },
  {
    question:
      "Which of the following would cause a shift to the left in the supply curve for a product?",
    options: [
      "A decrease in the price of inputs.",
      "An improvement in technology.",
      "A natural disaster that damages production facilities.",
      "A decrease in government regulations.",
    ],
    correctAnswer: "A natural disaster that damages production facilities.",
    explanation:
      "A shift to the left in the supply curve indicates a decrease in supply. A natural disaster that damages production facilities would reduce the ability to produce goods, thus decreasing supply.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "A change in the price of the good itself causes a movement along the supply curve, not a shift of the entire supply curve.",
  },
  {
    question:
      "An increase in the number of sellers in a market will typically:",
    options: [
      "Increase supply.",
      "Decrease supply.",
      "Not affect supply.",
    ...
    explanation:
      "An increase in the number of sellers in a market increases the market supply because more producers are offering goods or services for sale.",
  },
];
