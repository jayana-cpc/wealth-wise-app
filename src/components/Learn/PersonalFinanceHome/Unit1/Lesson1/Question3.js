...
export function Question3() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedAttempts =
        parseInt(localStorage.getItem("question3Attempts")) || 0;
  ...
  return (
    <div>
      ...
      <Text>
        You&rsquo;re at the grocery store and see a delicious new type of cereal
        on sale. You haven&rsquo;t tried it before, but the box boasts
        it&rsquo;s &quot;high in fiber.&quot; Without checking the ingredients
        list or your pantry to see if you already have cereal, you toss it in
        your cart. Is this a good financial decision?
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          No, impulsive purchases can strain your budget, and you should check
