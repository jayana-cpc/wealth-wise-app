...
export function Question1() {
  ...
  return (
    <div>
      ...
      >
        <Text>Create a budget: allocate some for the TV (considering your needs, not just wants), allocate funds for car tires, and plan to save the rest for the house down payment.</Text>
      </Modal>
    </div>
  );
}
