...
export function Question1() {
  ...
  return (
    <div>
      ...
      <Text>
        You&rsquo;ve been working hard and saved up a decent amount of money.
        You&rsquo;re considering using it for a dream vacation, but you also
        know you need a new laptop for school starting soon. Which PACED step(s)
        would be MOST helpful in making this decision?
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>Problem & Alternatives</Text>
      </Modal>
    </div>
  );
}
