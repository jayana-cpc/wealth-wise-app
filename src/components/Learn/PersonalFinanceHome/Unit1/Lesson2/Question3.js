...
export function Question3() {
  ...
  return (
    <div>
      ...
      <Text>
        You see an advertisement for a new investment opportunity promising high
        returns with minimal risk. However, you&rsquo;ve never invested before
        and don&rsquo;t know much about the financial market. How can the PACED
        model help you decide if this is a good opportunity?
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          By establishing what a good investment means to you (Criteria).
        </Text>
      </Modal>
    </div>
  );
