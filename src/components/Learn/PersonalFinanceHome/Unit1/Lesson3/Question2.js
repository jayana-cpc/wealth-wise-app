...
export function Question2() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const storedAttempts =
        parseInt(localStorage.getItem("question5Attempts")) || 0;
  ...
  return (
    <div>
      ...
      <Text>
        You decide to go back to school to get a higher-paying job. The
        opportunity cost of this decision includes:
      </Text>
      <Space h="sm" />
