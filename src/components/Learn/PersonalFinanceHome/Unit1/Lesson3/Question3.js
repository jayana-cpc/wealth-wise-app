  ...
  const handleSubmit = async () => {
    ...
    const APIBody = {
      ...
      messages: [
        {
          role: "system",
          content: `Evaluate the following answer for the question about the potential opportunity cost of accepting a promotion that requires longer work hours but comes with a significant raise. If the answer is correct, respond with "Correct". If the answer is incorrect, respond with "Incorrect" and provide a helpful response.`
        },
        {
          role: "user",
          content: userInput,
