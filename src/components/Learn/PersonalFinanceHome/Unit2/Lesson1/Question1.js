...
export function Question1() {
  ...
  return (
    <div>
      ...
      <Text>
        How does the concept of human capital explain the income gap between
      ...
      >
        <Text>
          Individuals with college degrees typically possess a higher level of
          human capital due to their additional education and training. This
          increased human capital often translates to higher productivity,
          greater job opportunities, and ultimately, higher earnings.
        </Text>
      </Modal>
    </div>
  );
