...
export function Question1() {
  ...
  return (
    <div>
      ...
      <Text>
        You are preparing your tax return and notice a discrepancy between the
        total wages reported on your W-2 and the total income you recorded
        throughout the year. Give one potential reason for this discrepancy and
        the steps you would take to resolve the issue.
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          Potential reasons for a discrepancy between your W-2 and your records
          include:
        </Text>
        <List>
          <List.Item>
            <b>Math errors:</b> Recheck your calculations for both your records
            and the W-2.
          </List.Item>
          <List.Item>
            <b>Missing income:</b> Ensure you have accounted for all income
            sources, such as tips, bonuses, or additional jobs.
          </List.Item>
          <List.Item>
            <b>Employer errors:</b> Contact your employer to verify the accuracy
            of the W-2.
          </List.Item>
          <List.Item>
            <b>Timing differences:</b> Check if the discrepancy is due to
            differences in pay periods or the timing of your records.
          </List.Item>
        </List>
        <Text>Steps to resolve the issue:</Text>
        <List>
          <List.Item>
            Carefully review your records and the W-2 for errors.
          </List.Item>
          <List.Item>
            Contact your employer to clarify the discrepancy.
          </List.Item>
          <List.Item>
            If the issue cannot be resolved, consider consulting a tax
