...
export function Question3() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const savedAttempts = parseInt(localStorage.getItem('question12Attempts')) || 0;
  ...
  return (
    <div>
      ...
      <Text>
        You are considering contributing to your employer&apos;s 401(k) retirement plan. 
        Explain the potential benefits and drawbacks of contributing to a 401(k) plan. 
        How would contributing to a 401(k) affect your paycheck and your overall financial situation?
      </Text>
      <Space h="sm" />
