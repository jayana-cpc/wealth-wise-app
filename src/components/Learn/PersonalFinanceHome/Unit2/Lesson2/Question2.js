...
export function Question2() {
  ...
  return (
    <div>
      ...
      >
        <Text>Several factors can contribute to a lower-than-expected net pay:</Text>
        <List>
          <List.Item><b>Taxes:</b> Federal, state, and local income taxes, as well as FICA taxes (Social Security and Medicare), are deducted from your gross pay.</List.Item>
          <List.Item><b>Health insurance premiums:</b> If you participate in your employer&apos;s health insurance plan, a portion of the premium is typically deducted from your paycheck.</List.Item>
          <List.Item><b>Other deductions:</b> Additional deductions might include retirement contributions (401(k)), life insurance, or other optional deductions.</List.Item>
        </List>
        <Text>
          To verify the accuracy of your paycheck, review the pay stub carefully. It should itemize all deductions. If you still have questions, contact your employer&apos;s payroll department for clarification. You can also use online paycheck calculators or tax preparation software to estimate your expected net pay.
        </Text>
      </Modal>
    </div>
  );
