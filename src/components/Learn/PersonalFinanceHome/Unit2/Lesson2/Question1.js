...
export function Question1() {
  ...
  return (
    <div>
      ...
      <Text>
        You are offered two jobs: one that pays an hourly wage of $15 and
        another that offers a salary of $30,000 per year. Assuming both
        positions require the same number of hours worked, how would you
        calculate the better pay option? What other factors might influence your
        decision beyond the pay rate?
      </Text>
      <Space h="sm" />
      ...
      >
        <Text>
          To determine the better pay option, you would need to calculate the
          annual salary equivalent of the hourly wage. Assuming a standard
          40-hour workweek and 52 weeks in a year, the hourly wage job would
          equate to $15/hour * 40 hours/week * 52 weeks/year = $31,200 per year.
          In this case, the hourly wage job offers a slightly higher annual
          income.
        </Text>
      </Modal>
    </div>
